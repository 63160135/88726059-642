...
<body style = "background-color:#FFF0F5">
    <div class="container">
        <h1>Employee | <a href='newstaff.php'><span class='glyphicon glyphicon-plus'style = "color:#F08080"></span></a> 
        <a href='documents.php'><span class='glyphicon glyphicon-arrow-left'style = "color:#F08080"></span></a></h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ค้นเลขที่คำสั่ง, ชื่อคำสั่ง" value="">
