    ...
    <div class="container">
        ...
        <form action="editactor.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="doc_num" id="doc_num" value="<?php echo $row->doc_num;?>" style = "background-color:#FFFFFF">
            </div>
            <div class="form-group">
                <label for="doc_title">ชื่อ</label>
                <input type="text" class="form-control" name="doc_title" id="doc_title" value="<?php echo $row->doc_title;?>" style = "background-color:#FFFFFF">
            </div>
            <div class="form-group">
                <label for="doc_start_date">วันที่เริ่ม</label>
                <input type="date" class="form-control" name="doc_start_date" id="doc_start_date" value="<?php echo $row->doc_start_date;?>" style = "background-color:#FFFFFF">
            </div>
            <div class="form-group">
                <label for="doc_to_date">วันที่สิ้นสุด</label>
                <input type="date" class="form-control" name="doc_to_date" id="doc_to_date" value="<?php echo $row->doc_to_date;?>" style = "background-color:#FFFFFF">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="doc_file_name">ชื่อไฟล์</label>
            ...
            <button type="submit" class="btn btn-success" style = "background-color:#6699FF">Save</button>
        </form>
</body>
