...
<body style = "background-color:#FFF0F5">
    <div class="container">
        <h1>Orders | <a href='newactor.php'><span class='glyphicon glyphicon-plus' style = "color:#F08080"></span></a>
        |<a href='staff.php?id=$row->id'><span class='glyphicon glyphicon-list-alt' style = "color:#F08080"></span></a>
        |<a href='selectdocument.php'><span class='glyphicon glyphicon-search'style = "color:#F08080"></span></a></h1>
        <a class="pull-right" href='logout.php'><span class='glyphicon glyphicon-off'style = "color:#F08080"></span></a></h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ค้นเลขที่คำสั่ง, ชื่อคำสั่ง" value=""  style = "background-color:#FFFFFF">
            <input type="submit" style = "background-color:#6699FF">
        </form>
        <?php
